		...
		$.each(response.data, function (k, v) {
			...
			$("#bookings-tbody").append(`
				<tr>
					...
					<td data-label="${ChangeString('Booking No', 'رقم الحجز')}">${v.BookingNo}</td>
					...
					${/*<td data-label="Action"><a class="" href="/Customer/Booking/Details/${v.ID}">View</a></td>*/''}
					<td data-label="${ChangeString('Action', 'عمل')}">
                        <ul>
							<li><a href="/Customer/Booking/Details/${v.ID}"><span class="ti-folder"></span> ${ChangeString('View', 'رأي')}</a></li>
                            ${/*
