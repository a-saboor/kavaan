            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        actions += '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Project/Edit/' + data[1] + '" title="Edit"> ' +
                            '<i class="fa fa-pen"></i>' +
                            '</a> ';

                        //actions += '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Project/Details/' + data[1] + '" title="View">' +
                        //    '<i class="fa fa-eye"></i>' +
                        //    '</a> ';
...
function Delete(element, record) {
    ...
    swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: '/Admin/Project/Delete/' + record,
                type: 'POST',
                data: {
...
//			$.ajax({
//				url: '/Admin/Project/Activate/' + record,
//				type: 'Get',
