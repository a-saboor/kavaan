                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        if (full[2] === "admin@KAVAAN.com") {
                            actions += '<button type="button" class="btn btn-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/NewsFeed/Details/' + data[1] + '\')" title="View">' +
                            ...
                            actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/NewsFeed/Edit/' + data[1] + '\',true)">' +
                                '<i class="fa fa-pen"></i>' +
                                '</button> ' +
