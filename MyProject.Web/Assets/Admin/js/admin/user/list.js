			...
			columnDefs: [
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						var actions = '';
						let email = full[1].split('|')[1];
						if (email === "admin@kavaan.com") {
				...
				
				{
					...
					render: function (data, type, full, meta) {
						...
						return '<div class="d-flex align-items-center">' +
							'<div>' +
							'<a class="text-dark-75 font-weight-bolder mb-1 font-size-lg">' + user[0] + '</a><br>' +
							'<a class="text-muted font-weight-bold d-block text-hover-primary">' + user[1] + '</a>' +
							'</div>' +
							'</div>';
