            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        actions += '<a class="btn btn-bg-secondary btn-icon btn-sm mr-1" href="/Admin/Customer/EditProfile/' + data[1] + '">' +
                            '<i class="fa fa-pen"></i>' +
                            '</a> ' +
                            '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/Customer/Details/' + data[1] + '\')" title="View">' +
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return '<div class="d-flex align-items-center">' +
                            '<div>' +
                            '<a href="javascript:void(0);" class="text-dark-75 font-weight-bolder mb-1 font-size-lg">' + customer[0] + '</a><br>' +
                            '<a class="text-dark-75 text-hover-primary mb-1 font-size-lg">' + customer[2] + '</a><br>' +
                            '<a href="javascript:void(0);" class="label label-inline font-weight-bolder mb-2 text-left opacity-70" >' + '+' + customer[3] + customer[1] + '</a>' +
                            '</div>' +
                            '</div>';
                    },
                },
...
function addRow(row) {
    table1.row.add([
        row.Date,
        row.UserName + '|' + row.Contact + '|' + row.Email + '|' + row.PhoneCode,
        row.IsActive,
        row.IsActive + ',' + row.ID,
    ]).draw(true);
