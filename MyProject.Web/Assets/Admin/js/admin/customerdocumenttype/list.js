			...
			columnDefs: [
				...
				},
				{
					...
					render: function (data, type, full, meta) {
						...
						//	actions += '<button type="button" class="btn btn-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/CustumerDocument/Details/' + data[1] + '\')" title="View">' +
						...
						//}
							...
							actions += '<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/CustomerDocumentType/Edit/' + data[1] + '\',true)">' +
								'<i class="fa fa-pen"></i>' +
								'</button> ' +
								'<button type="button" class="btn btn-bg-secondary btn-icon btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/CustomerDocumentType/Details/' + data[1] + '\',true)">' +
...
function Delete(element, record) {
	...
	swal.fire({
		...
		if (result.value) {
			...
			$.ajax({
				url: '/Admin/CustomerDocumentType/Delete/' + record,
				type: 'POST',
				data: {
	...
	swal.fire({
		...
		if (result.value) {
			...
			$.ajax({
				...
				url: '/Admin/CustomerDocumentType/Activate/' + record,
				type: 'Get',
