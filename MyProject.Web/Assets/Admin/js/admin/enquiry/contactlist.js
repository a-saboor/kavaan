			...
			columnDefs: [
...

				{
					...
					render: function (data, type, full, meta) {
						...
						var actions = '<button type="button" class="btn btn-bg-secondary btn-sm mr-1" onclick="OpenModelPopup(this,\'/Admin/Enquiry/Message/' + data + '\')">' +
...
jQuery(document).ready(function () {
	...
	$("#btnSearch").on("click", function () {
		...
		$.ajax({
			url: '/Admin/Enquiry/ContactEnquiryList/',
			type: 'POST',
			data: {
