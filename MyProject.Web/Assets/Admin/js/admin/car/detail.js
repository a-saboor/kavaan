            ...
            success: function (response) {
                if (response.success) {
                    ...
                    $(response.categories).each(function (k, v) {
                        $('.car-categories').append('<div class="car-category car-category-plain mb-1" id="car-category' + v.id + '">' +
                    ...
                    $(response.carCategories).each(function (k, v) {
                        $("#chkCategory" + v.FeatureID).prop('checked', true).attr('FeatureID', v.id);
                    });
                    ...
                    $('.car-category input[type="checkbox"]').change(function () {
                        ...
                        if ($(chkcategory).prop('checked')) {
                            $.ajax({
                                ...
                                success: function (response) {
                                    if (response.success) {
                                        $(chkcategory).attr('FeatureID', response.data);
                            ...
                            $.ajax({
                                url: '/Vendor/CarFeature/Delete/' + $(chkcategory).attr('FeatureID'),
                                type: 'POST',
                                data: {
                ...
                if (response.success) {
                    ...
                    $(response.document).each(function (k, v) {
                        ...
                        html += `<div class="row mt-1 ${v.id}">
                                            ...
                                            <div class="col-sm-1">
                                               <a  href="${v.path}" class="btn btn-bg-secondary btn-icon btn-sm mr-1 ml-14" target="blank"> <span class="fas fa-eye"></span></a>
                                            </div>
