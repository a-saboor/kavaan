            ...
            },
            {
                ...
                render: function (data, type, full, meta) {
                    ...
                    if (typeof data === 'undefined') {
                        return '<a href="javascript:" class="label label-lg label-light-danger label-inline">' + data + ' </a>';
                    }
                    else if (data === "-") {
                        return '<a href="javascript:" class="label label-lg label-light-danger label-inline">' + 'Not Assigned' + ' </a>';
                    }
                    return '<a href="javascript:" class="label label-lg label-light-success label-inline">' + data + ' </a>';
                },
                },
                {
                    targets: 4,
