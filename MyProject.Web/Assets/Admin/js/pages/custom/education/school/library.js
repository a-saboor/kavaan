			...
			columns: [
				 {
					...
					template: function(data) {
						...
						output = '<div class="d-flex align-items-center">\
							...
							<div class="ml-4">\
								<a href="javascript:void(0);" class="text-dark-75 text-hover-primary font-weight-bolder font-size-lg mb-0">' + data.CompanyName + '</a>\
					...
					template: function(row) {
						...
						output += '<a href="javascript:void(0);" class="text-dark-50 text-hover-primary font-weight-bold">' + row.CompanyAgent + '</a>';
