			...
			columns: [
				 {
                    ...
                    template: function(data) {
                        ...
                        var output = '<div class="d-flex align-items-center">\
                            ...
                            <div class="ml-4">\
                                ...
                                <a href="javascript:void(0);" class="text-muted font-weight-bold text-hover-primary">' + data.CompanyEmail + '</a>\
                            </div>\
                        </div>';
					...
					template: function(row) {
						...
						output += '<a href="javascript:void(0);" class="text-dark-50 text-hover-primary font-weight-bold">' + row.CompanyName + genre[genreIndex1].title + '</a>';
								...
								<span class="svg-icon svg-icon-md">\
									<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
											...
											<path d="M14,4.5 L14,4 C14,3.44771525 13.5522847,3 13,3 L11,3 C10.4477153,3 10,3.44771525 10,4 L10,4.5 L5.5,4.5 C5.22385763,4.5 5,4.72385763 5,5 L5,5.5 C5,5.77614237 5.22385763,6 5.5,6 L18.5,6 C18.7761424,6 19,5.77614237 19,5.5 L19,5 C19,4.72385763 18.7761424,4.5 18.5,4.5 L14,4.5 Z" fill="#ffffff" opacity="0.3"/>\
										</g>\
									</svg>\
								</span>\
	                        </a>\
