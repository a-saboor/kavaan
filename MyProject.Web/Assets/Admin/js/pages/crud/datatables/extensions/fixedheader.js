					...
					render: function(data, type, full, meta) {
                        ...
                        <span class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="javascript:void(0);"><i class="la la-edit"></i> Edit Details</a>
                                <a class="dropdown-item" href="javascript:void(0);"><i class="la la-leaf"></i> Update Status</a>
                                <a class="dropdown-item" href="javascript:void(0);"><i class="la la-print"></i> Generate Report</a>
                            </div>
                        </span>
                        <a href="javascript:void(0);" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="View">
