...
$(document).ready(function () {
	...
	$('#projects_section .main-div').empty().html(return_loading_section(0));
...
function BindGridArticles(data) {
	...
	$.each(data, function (k, v) {
		...
		$('#projects_section .main-div').append(`
			<div class="mb-8 w-full sm:w-[47.5%] lg:w-[17.5%] ml-1 relative">
				<img src="${v.Image}" alt="" class="rounded-lg mb-2 w-full h-[15rem] object-cover">
				<p class="font-Rubik text-xs uppercase">${v.Title}</p>
				<div class="top-[36%] w-full absolute mx-auto">
					<a href="${v.VRTour}" target="_blank">
						<img src="/Assets/images/web-icons/virtual-tour.png" alt="" class="w-16 mx-auto">
					</a>
				</div>
			</div>
		`);
	...
	if ($('#projects_section .main-div section')) {
		$('#projects_section .main-div section').remove();
	}
