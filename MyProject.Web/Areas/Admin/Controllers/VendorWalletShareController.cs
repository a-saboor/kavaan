...
using Project.Web.Areas.Admin.ViewModels.VendorWalletShare;
using System;
...
namespace Project.Web.Areas.Admin.Controllers
{
    ...
    public class VendorWalletShareController : Controller
    {
        ...
        //            if (order != null)
        //            {
        //                /*Amount Tranfer To Vendor Wallet Per Booking*/
        //                VendorWalletShareHistory vendorWalletShareHistory = new VendorWalletShareHistory()
        //                {
        //                    VendorID = vendor.ID,
        ...
        //                {
        //                    VendorWalletShareHistoryOrder vendorWalletShareHistoryOrder = new VendorWalletShareHistoryOrder()
        //                    {
        ...
        //                    /*Commission deduction Per Booking*/
        //                    //vendorWalletShareHistory = new VendorWalletShareHistory()
        //                    //{
        //                    //    VendorID = vendor.ID,
        //                    //    Description = string.Format("Booking no {0} commission amount deducted from your wallet (On my way Commission).", order.OrderNo),
        ...
        //                    //if (_vendorwalletsharehistoryService.CreateVendorWalletShareHistory(ref vendorWalletShareHistory, ref message))
        //                    //{
        //                    //    vendorWalletShareHistoryOrder = new VendorWalletShareHistoryOrder()
        //                    //    {
        //                    //        VendorWalletShareHistoryID = vendorWalletShareHistory.ID,
        //                    //        OrderID = order.ID
        //                    //    };
        ...
        //            VendorWalletShare.TotalEarning -= VendorWalletShare.PendingAmount;
        //            if (VendorWalletShare.TotalEarning > 0)
        //            {
        //                VendorWalletShare.PendingAmount = 0;
        //            }
        //            else
        //            {
        //                VendorWalletShare.PendingAmount = -1 * VendorWalletShare.TotalEarning;
        //            }
        ...
        //                {
        //                    VendorID = vendor.ID,
        //                    Description = string.Format("AED {0} withdrawed from wallet and will be transfered to {1}.", totalTransferedAmount, vendor.IBAN),
