...
namespace Project.Web.Areas.Admin.Controllers
{
    ...
    public class VendorWalletShareHistoryController : Controller
    {
        ...
        public VendorWalletShareHistoryController(IVendorWalletShareHistoryService vendorwalletsharehistoryService
            , IVendorWalletShareService VendorWalletShareService
            , IVendorService vendorService
            , IVendorWithdrawalRequestService VendorWithdrawalRequestService
        ...
        public ActionResult TransferAmount(long VendorID, decimal TransferedAmount)
        {
            ...
            try
            {
                ...
                if (_VendorWalletShareService.UpdateVendorWalletShare(ref VendorDetail, ref message))
                {
                    ...
                    if (_notificationService.CreateNotification(not, ref message1))
                    {
                        ...
                        if (_notificationReceiverService.CreateNotificationReceiver(notRec, ref message1))
                        {
                        }
                    }
        ...
        public ActionResult AcceptRequest(VendorWithdrawalRequest ApprovalRequest)
        {
            ...
            try
            {
                if (_VendorWithdrawalRequestService.UpdateRequest(ref ApprovalRequest, ref message, true))
                {
                    ...
                    {
                        message = "Amount transfer declined!";
                    }
